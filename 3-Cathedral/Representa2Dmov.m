function Representa2Dmov(x,y,barras,Q,gif)
%
% Representa las oscilaciones 
...
%      Q:   Matriz donde cada columna contiene las coordenadas generalizadas
%           de la estructura en un instante distinto
%
...
[gdl,Nt]=size(Q); % Número de gdls y número de instantes temporalres 
...
for i_t=1:Nt
    ...
    for i=1:Nb
        plot( x(barras(i,:))+Amp*dx(barras(i,:)) , ...
              y(barras(i,:))+Amp*dy(barras(i,:)) , ...
              'g' , 'LineWidth',2 ); 
        hold on
    end
